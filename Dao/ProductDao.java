...
public interface ProductDao extends Dao
{
	 ...
	 * elements.
	 * @throws IllegalArgumentException if <code>category</code> is <code>null</code>
	 */
	SearchResult<ProductModel> findProductsByCategory(CategoryModel category, int start, int count);

	/**
	 * @param category the category the returned products belong to
	 * @param online   true for online products, or false for offline products
	 ...
	 *
	 * @param catalogVersion the product <code>catalogVersion</code>
	 * @return a {@link ProductModel}
	 * @throws IllegalArgumentException if the given <code>catalogVersion</code> is <code>null</code>
	 */
	...
	List<ProductModel> findProductsWithOne();
}
